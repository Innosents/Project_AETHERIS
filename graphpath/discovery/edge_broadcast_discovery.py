...
class EdgeBroadcastEngine:
    ...
    def _probe_voip_cluster(self, bcast_ip: str) -> List[Dict[str, Any]]:
        ...
        sip_options_packet = (
            ...
            b"Via: SIP/2.0/UDP 0.0.0.0:5060;branch=z9hG4bK-graphpath-probe\r\n"
            b"Max-Forwards: 70\r\n"
            b"From: <sip:graphpath@discovery.local>;tag=gp001\r\n"
            b"To: <sip:ping@224.0.1.75>\r\n"
            b"Call-ID: graphpath-pnp-discovery\r\n"
            b"CSeq: 1 OPTIONS\r\n"
            b"User-Agent: GraphPath-VoIP-Discovery/2.0\r\n"
            b"Content-Length: 0\r\n\r\n"
        )
    ...
    def _probe_camera_cluster(self, bcast_ip: str) -> List[Dict[str, Any]]:
        ...
        ws_probe_msg = (
            ...
            '<soap:Header>'
            '<wsa:MessageID>uuid:graphpath-wsd-probe-01</wsa:MessageID>'
