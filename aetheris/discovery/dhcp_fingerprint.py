"""
Project AETHERIS - Dhcp Fingerprint
Passively sniffs and decodes BOOTP/DHCP transaction frames to extract RFC 2132 Option 55 parameter request vectors and Option 60 vendor class identifiers. Matches discrete option sequence tuples 
against empirical OS signature tables to achieve passive operating system fingerprinting.
"""
