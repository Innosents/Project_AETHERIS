...
and physical network switch-port Project AETHERISs into unified spatial telemetry.
"""
...
class PublicGeoIpResolver:
    ...
    def resolve_ip(cls, ip: str, force_refresh: bool = False) -> Dict[str, Any]:
        ...
        if (ip.startswith("127.") or ip.startswith("10.") or
            ...
            os.environ.get("AETHERIS_OFFLINE") == "1" or
        ...
        try:
            ...
            req = urllib.request.Request(
                url,
                headers={"User-Agent": "Aetheris-Discovery-Engine/2.0 (Spatial Network Topology)"}
            )
