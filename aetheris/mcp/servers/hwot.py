...
@mcp.tool()
def hwot_spawn_cip_plc(port: int = 44818) -> Dict[str, Any]:
...
@mcp.tool()
def hwot_spawn_s7_plc(port: int = 10102) -> Dict[str, Any]:
...
@mcp.tool()
def hwot_kill_all() -> Dict[str, Any]:
    ...
    return {"terminated_ports": terminated}
